...
extension UserModel
{
    ...
    func requestForValidateTruckNumberRequestBody(params:[AnyObject]) ->[NSObject:AnyObject]
    {
        let validateTruckNumberRequestBody = model.prepareValidateTruckNumberRequestBody(params)
    ...
    func requestForpollLocationUpdateBody(params:[AnyObject]) ->[NSObject:AnyObject] {
        let profileUpdateBody = model.preparePollLocationeUpdateRequestBody(params)
        return profileUpdateBody
    }
