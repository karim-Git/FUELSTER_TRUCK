...
@objc protocol CustomeCellDelegate {
    ...
    optional func cellPushButtonAction(cell:UITableViewCell) -> Void
       ...
       optional func HomeNewOrderCellAcceptOrder(cell:UITableViewCell) -> Void
        optional func HomeNewOrderCellCancelOrder(cell:UITableViewCell) -> Void
    optional func HomeAcceptedOrdrsCellCompleteOrder(cell:UITableViewCell) -> Void
